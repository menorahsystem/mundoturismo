...
<head>
    ...
    <title>Criar Ponto Turístico | Admin - ExploreNow</title>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-gray-50 rounded-xl p-6 space-y-4">
                                    ...
                                    <div>
                                        <label for="estado" class="block text-sm font-medium text-gray-700 mb-2 flex items-center space-x-2">
                                            <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                            </svg>
                                            <span>Estado/Província</span>
                                        </label>
                                        <input type="text" name="estado" id="estado" value="{{ old('estado') }}" placeholder="Ex.: RJ, SP, CA, NY (opcional)"
                                               class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" maxlength="100">
                                        @error('estado')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
